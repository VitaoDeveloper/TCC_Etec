    ...
    <section class="auth-panel">
      <div class="auth-card">
        ...
        <form id="registerForm" class="auth-form" method="POST" action="insertion.php">
          ...
          <div class="auth-field"><label class="auth-label" for="number">Número</label><div class="auth-input-wrap"><input type="text" id="number" name="number" maxlength="6" placeholder="Número ou S/N" value="<?php echo htmlspecialchars($old['number'] ?? '', ENT_QUOTES, 'UTF-8'); ?>" required></div></div>
