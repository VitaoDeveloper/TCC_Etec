    ...
    <section class="auth-panel">
      <div class="auth-card">
        ...
        <form id="registerForm" class="auth-form" method="POST" action="insertion.php">
          ...
          <div class="auth-field"><label class="auth-label" for="cpf">CPF</label><div class="auth-input-wrap"><input type="text" id="cpf" name="cpf" placeholder="000.000.000-00" maxlength="14" inputmode="numeric" value="<?php echo htmlspecialchars($old['cpf'] ?? '', ENT_QUOTES, 'UTF-8'); ?>" required oninput="this.value=this.value.replace(/\D/g,'').replace(/(\d{3})(\d)/,'$1.$2').replace(/(\d{3})\.(\d{3})(\d)/,'$1.$2.$3').replace(/(\d{3})\.(\d{3})\.(\d{3})(\d)/,'$1.$2.$3-$4')"></div></div>
          ...
          <div class="auth-field"><label class="auth-label" for="senha">Senha</label><div class="auth-input-wrap"><input type="password" id="senha" name="password" autocomplete="new-password" required minlength="8"><button type="button" class="password-toggle" id="togglePassword" aria-label="Mostrar ou ocultar senha"><i class="fas fa-eye"></i></button></div></div>
          <div class="auth-field"><label class="auth-label" for="confirm_senha">Confirmar senha</label><div class="auth-input-wrap"><input type="password" id="confirm_senha" autocomplete="new-password" required></div></div>
