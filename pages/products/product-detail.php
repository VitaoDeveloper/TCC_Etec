...
<div class="admin-table-container" style="padding:30px;"><img src="<?php echo htmlspecialchars($product['image_path'] ?: '../../assets/img/placeholder-product.jpg', ENT_QUOTES, 'UTF-8'); ?>" alt="<?php echo htmlspecialchars($product['name'], ENT_QUOTES, 'UTF-8'); ?>" style="max-width:320px; border-radius:10px; margin-bottom:20px;">
